			...
			<div className="w-full max-w-md">
				<div className="w-full max-w-md overflow-hidden rounded-2xl shadow-sm ring-1 ring-red-200">
					<div className="bg-red-900 p-8 text-center">
						...
						<p className="pt-2">
							Crea tu cuenta y comienza a crear tu colección.
						</p>
					</div>
					...
					<div className="bg-white p-8">
						<form className="space-y-5" action={formAction}>
							...
							<button
								type="submit"
								disabled={pending}
								className={`w-full rounded-lg bg-red-900 px-4 py-3 text-sm font-semibold text-white transition hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 ${
									pending
										? "cursor-not-allowed opacity-50"
										: "cursor-pointer hover:bg-red-700"
								}`}
							>
								{pending ? "Registrando..." : "Regístrate"}
							</button>
